...
SCHEMA_PATH = Path('C:/Users/Inteli/OneDrive/Documentos/GitHub/2023-M1-programacao/Semana-08/back-end/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'windows': 'C:\\Users\\Inteli\\.cache\\prisma-python\\binaries\\4.11.0\\8fde8fef4033376662cad983758335009d522acb\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    coordinate: 'actions.CoordinateActions[models.Coordinate]'
    ...
    def __init__(
        ...
        *,
        ...
        self.coordinate = actions.CoordinateActions[models.Coordinate](self, models.Coordinate)
...
class Batch:
    coordinate: 'CoordinateBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.coordinate = CoordinateBatchActions(self)
...
class CoordinateBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.CoordinateCreateInput,
        include: Optional[types.CoordinateInclude] = None
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='createOne',
    ...
    def create_many(
        self,
        data: List[types.CoordinateCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.CoordinateWhereUniqueInput,
        include: Optional[types.CoordinateInclude] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
    ...
    def update(
        self,
        data: types.CoordinateUpdateInput,
        where: types.CoordinateWhereUniqueInput,
        include: Optional[types.CoordinateInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.CoordinateWhereUniqueInput,
        data: types.CoordinateUpsertInput,
        include: Optional[types.CoordinateInclude] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
    ...
    def update_many(
        self,
        data: types.CoordinateUpdateManyMutationInput,
        where: types.CoordinateWhereInput,
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='updateMany',
    ...
    def delete_many(
        self,
        where: Optional[types.CoordinateWhereInput] = None,
    ) -> None:
        self._batcher._add(
            operation='mutation',
            method='deleteMany',
