...
class BaseCoordinate(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Coordinate']] = 'Coordinate'

    @classmethod
    def prisma(cls: Type[_PrismaModelT]) -> 'actions.CoordinateActions[_PrismaModelT]':
        from .client import get_client

        return actions.CoordinateActions[_PrismaModelT](get_client(), cls)
